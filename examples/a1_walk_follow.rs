// It's the same as a1_walk.rs, but the camera follows the robot
...
fn robot_control_loop(
    ...
    bodies_query: Query<(Entity, &mut Transform, &MuJoCoBody, Without<Camera3d>)>,
) {
    ...
    for mut transform in cameras.iter_mut() {
        ...
        let target = Vec3::new(root_body_transform.x, 0.0, root_body_transform.z);
        transform.translation = target - Vec3::new(2.0, -3.0, 2.0);
